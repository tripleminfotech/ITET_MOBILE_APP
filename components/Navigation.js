...
import VideoPlayer from '../screens/Lessons';
import QandA from '../screens/QandA';
import Test from '../screens/Test';
import Certificate from '../screens/Certificate';
import Review from '../screens/Rating';
...
import UserCertificates from '../screens/UserCertificates';
...
import VideoLoginScreen from '../screens/LoginScreen';
...
function VideoStackNavigator(){
  return (
      <VideoStack.Navigator>
        ...
        />
        <VideoStack.Screen name="Call" component={CallScreen} options={{headerShown: false}}/>
      </VideoStack.Navigator>
  );
}
...
const MessageHeader = ({route}) =>{
  return (
    ...
    <View style={{flex:1,flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
      ...
      <View>
        ...
        <Text style={{marginLeft:10,color:"#8F9BB3",fontSize:12}}>Online</Text>
      </View>
  ...
  const tabConnector = connect(state => ({ value: state.notificationItems.notification,read:state.notificationItems.read,unread:state.notificationItems.unread }))(MyTabs);

...
class CartScreen extends Component {
    ...
    _renderItem = ({item}) =>{
        return(
    <TouchableOpacity onPress={() => this.onPress(item.id)} style={{ marginLeft: 20, marginBottom:15,backgroundColor:"white",borderRadius:10,flexDirection:"row",alignItems:"center",justifyContent:"space-between",padding:20,marginRight:20}}>
    ...
    _onPressButton(emptyCart) {
              ...
              var options = {
                  ...
                  image: 'https://itexperttraining.com/wp-content/uploads/2019/09/Website_logo_black.png',
                  currency: 'INR',
        ...
        return (
            ...
            <View style={{flex:1}}>
                ...
                <View style={{flexDirection:"row",justifyContent:"space-between",margin:15}}>
                            <Text style={{fontSize:20}}>Item ({this.props.cartItems.length})</Text>
                            <Text style={{fontSize:20}}>Total: ₹{this.props.total}</Text>
                        </View>
                    <View style={{flexDirection:"row",justifyContent:"space-between"}}>
                    <TextInput
                        style={{ height: 40,width:"75%",marginLeft:10, borderColor: 'gray', borderBottomWidth:0.5,borderRadius:15 }}
                    ...
                    {this.state.loading?
                        ...
                        :<TouchableOpacity disabled={this.state.value.length > 1 ? false : true} onPress={()=>this._coupon()} style={{backgroundColor:this.state.value.length > 1 ? appColor : "gray",padding:10,marginRight:10,borderRadius:15}}>

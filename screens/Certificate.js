...
import { StyleSheet, View,Text, StatusBar,
    SafeAreaView, Image, Button, ImageBackground, Platform, PermissionsAndroid, Share} from 'react-native';
  ...
  // };
    ...
    render(){
        return(
            ...
            <View>
              <ProgressBar style={{height:10,borderRadius:8}} progress={this.state.progress} color={appColor} />
            ...
            <ImageBackground 
                ...
                <View style={{flex:1,justifyContent: "center",
                    ...
                    <Text style={{fontSize:22,color:"white",marginBottom:10}}>Certificate</Text>
                    <Text style={{fontSize:25,color:"white",textAlign:"center"}}>{this.props.route.params.title}</Text>
                </View>
                <View style={{flex:1}}>
                    <View style={styles.row_items}>
                    <Text style={styles.row_text}>Language</Text>
                    <Text style={styles.row_text}>{this.props.route.params.language}</Text>
                    </View>
                    <View
                        style={styles.line}
                        />
                    ...
                    <Text style={styles.row_text}>{this.props.route.params.level}</Text>
                    </View>
                    <View
                        style={styles.line}
                        />
                    ...
                    <Text style={styles.row_text}>{this.props.route.params.instructor_name}</Text>
                    </View>
                    <View
                        style={styles.line}
                        />
                ...
                <View style={{flex:1}}>
                    <TouchableOpacity onPress={()=>this.checkPermission(this.state.data.path)} style={styles.SubmitButtonStyle}>
                        <Text style={styles.TextStyle}>Download Now</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={this.onShare} style={styles.SubmitButtonStyle}>

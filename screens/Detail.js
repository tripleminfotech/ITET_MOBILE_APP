...
import {
  ...
  Text,
  TouchableOpacity,
  StyleSheet, Image, Dimensions, ImageBackground, YellowBox, LogBox, AsyncStorage, Alert
} from 'react-native';
...
export default function Detail({route,navigation}){
    ...
    return(
      ...
      <FlatList
      ListHeaderComponent = {
        <ImageBackground source={{ uri: category.thumbnail }} style={{ height:250, resizeMode: 'cover',flexDirection:"column-reverse",marginBottom:10}}>
                 <Text style={{color:"white",marginLeft:10}}>{data.length} courses</Text>
                 <Text style={{color:"white",marginLeft:10,fontSize:30}}>{category.name}</Text>

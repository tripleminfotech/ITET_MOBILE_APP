...
export default class MyWishlist extends React.Component {
        ...
        return(
                ...
                <TouchableOpacity onPress={() => onPress(item.id)} style={{ marginLeft: 20, marginBottom:15,backgroundColor:"#F4F4F4",borderRadius:10,flexDirection:"row",alignItems:"center",justifyContent:"space-between",padding:20,marginRight:20}}>
                  ...
                  <TouchableOpacity onPress={() => click(item.id)}>
                    <Icon name={"heart"} color={"red"} size={20} style={{marginLeft:10}} />
                </TouchableOpacity>
                </TouchableOpacity>
    ...
    render(){
        return (
            ...
            <View style={{}}>  
                <Text style={{fontSize:20,textAlign:"center",margin:20}}>My Wishlist</Text>
            </View>
            {this.state.login?<View style={{flex:1,justifyContent:"center",alignItems:"center",backgroundColor:"white"}}>
                ...
                <View style={{marginTop:40,marginRight:20,marginLeft:20,flexDirection:"column",alignItems:"center"}}>
                    <Text style={{fontSize:32,textAlign:"center"}}>WISH TO LEARN</Text>
                    <Text style={{textAlign:"center",fontSize:16,margin:20,lineHeight:30}}>Tag your favorite courses here and learn them when you are ready</Text>
                </View>
            ...
            <FlatList
                ...
                // }
                    ...
                    renderItem={({ item }) => <this.CourseComponent item={item} onPress={this.onPress} click={this.onPresss} />}

...
import { StyleSheet, View,Text, StatusBar,
    SafeAreaView, Image, Button} from 'react-native';
import AppIntroSlider from 'react-native-app-intro-slider';
import { TouchableOpacity } from 'react-native-gesture-handler';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import { NavigationActions } from 'react-navigation';
import globalStyle from '../components/Style';
import { SliderOne, SliderThree, SliderTwo } from '../slider';
  ...
  export default class SliderScreen extends React.Component {
      ...
      return (
        <View
          ...
          <SafeAreaView style={styles.slide}>
            ...
            <Text style={{marginTop:10,textAlign:"center",color:"#8F9BB3"}}>{item.text}</Text>
          </SafeAreaView>
          <View style={{marginLeft:20,marginRight:20,marginBottom:100,flexDirection:"row",justifyContent:"center",alignItems:"center",alignContent:"center"}}>
          <TouchableOpacity onPress={()=>navigation.navigate('login')} style={{...globalStyle.appColor,padding:15,borderRadius:15}}>
              <Text style={{textAlign:"center",color:"white"}}>start learning</Text>
            </TouchableOpacity>
            ...
            })} style={{...globalStyle.appColor,marginLeft:10,padding:15,borderRadius:15}}>
              <Text style={{textAlign:"center",color:"white"}}>continue as guest</Text>
            </TouchableOpacity>
          </View>
    ...
    render() {
      return (
       ...
       data={slides} onDone={()=>console.log('ok')}/>
       </View>
      )
    }
  }
      ...
      <TouchableOpacity
        onPress={() =>
          navigation.navigate('StartCourse', {
            screen: 'Lesson',
            params: {id: id, duration: item.duration},
          })
        }
        ...
        <View
          ...
          <Text style={{color: '#8F9BB3', textAlign: 'center'}}>
            {item.note}
          </Text>
      ...
      <ScrollView>
        ...
        {nodata ? (
          ...
          <SectionList
            ...
            renderItem={({item, index, section: {id}}) => (
              <SectionItem item={item} index={index} id={id} />
            )}

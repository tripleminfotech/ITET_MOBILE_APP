...
import defaultAvatar from '../assets/Oval.png';
  ...
  return (
    <ScrollView>
      <View
        ...
        />
        <Text style={{marginTop: 10, fontSize: 22, color: 'white'}}>
          {data.first_name} {data.last_name}
        </Text>
        <Text style={{marginTop: 10, fontSize: 17, color: 'white'}}>
          Point Earned : {data.points}
        </Text>
      </View>
      <View
        style={{
        ...
        <View
          ...
          <Text style={{fontSize: 36, color: 'white', marginTop: 10}}>
            {data.video}
          </Text>
        </View>
        <View

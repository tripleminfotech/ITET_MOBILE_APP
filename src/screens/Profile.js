...
import defaultAvatar from '../../src/assets/Oval.png';
  ...
  handlePicker = async () => {
    ...
    await ImagePicker.showImagePicker({}, async (response) => {
      ...
      if (response.didCancel) {
        ...
        let json = await Api('/profile/image/update', 'POST', {
        ...
        {this.state.login ? (
          <View
            ...
            <View
              ...
              <Text
                ...
                Be one among the {appName} pro learner. Login Now and update
                your profile.
              </Text>
            </View>
            <TouchableOpacity
          ...
          <ScrollView>
            <View
              ...
              <TouchableHighlight onPress={() => this.handlePicker()}>
                <Image
                  ...
                  style={{borderRadius: 50, height: 105, width: 105}}
                />
              </TouchableHighlight>
              <Text style={{marginTop: 10, fontSize: 22}}>
                {this.state.data.first_name} {this.state.data.last_name}
              </Text>
              <Text style={{fontSize: 15, color: '#8F9BB3'}}>
                {this.state.data.email}
              </Text>
              <Text
                style={{color: appColor, margin: 10}}
            ...
            <View
              ...
              <TouchableOpacity
                onPress={() =>
                  this.props.navigation.navigate('usercertificates')
                }
                style={{
                  flexDirection: 'row',
                  justifyContent: 'space-between',
              ...
              <TouchableOpacity
                onPress={() => this.props.navigation.navigate('userbookmark')}
                style={{
                  flexDirection: 'row',
                  justifyContent: 'space-between',
                  margin: 10,

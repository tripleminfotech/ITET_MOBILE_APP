    ...
    return (
      <TouchableOpacity
        ...
        <View
          ...
          <CheckBox value={item.is_completed === 0 ? false : true} />
          <Text style={{fontSize: 17, color: 'white'}}>{item.title}</Text>
        </View>
        <Text style={{marginTop: 5, marginLeft: 30, color: '#C5CEE0'}}>
          {item.duration}
        </Text>
      </TouchableOpacity>
    );
        ...
        <ScrollView style={{backgroundColor: 'white'}}>
          ...
          <View
            ...
            <View
              ...
              <ProgressBar
                progress={completion}
                color={Colors.white}
                style={{marginBottom: 10, height: 8, borderRadius: 8}}
              />
          ...
          <View>
            ...
            <View
              ...
              <Text style={{fontSize: 15, marginBottom: 5, color: '#8F9BB3'}}>
                Category
              </Text>
